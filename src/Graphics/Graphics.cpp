/**
 * @file Graphics.cpp
 * @brief Implementation of the global graphics context and Vulkan/Diligent
 * bridge.
 */
...
// GpuSurface implementation details
struct GpuSurface {
...
void *GLFWDiligentRenderingDevice::alloc(usz size) { return new GpuSurface(); }
