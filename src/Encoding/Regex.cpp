#include "../../include/Encoding/Regex.hpp"
...
Array<String> String::split(const Encoding::Regex &reg) const {
  Array<String> r;
...
String String::replace(const Encoding::Regex &reg, const String &rep) const {
  String r;
  auto m = reg.matchAll(*this);
  long long e = 0;
  for (int i = 0; i < (int)m.size(); ++i) {
